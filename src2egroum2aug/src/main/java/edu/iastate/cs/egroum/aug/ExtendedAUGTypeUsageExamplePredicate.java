...
public class ExtendedAUGTypeUsageExamplePredicate implements UsageExamplePredicate {
    ...
    public static ExtendedAUGTypeUsageExamplePredicate usageExamplesOf(String... fullyQualifiedTypeNames) {
        return new ExtendedAUGTypeUsageExamplePredicate(fullyQualifiedTypeNames);
    }

    protected ExtendedAUGTypeUsageExamplePredicate(String... fullyQualifiedTypeNames) {
